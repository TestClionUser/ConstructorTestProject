...
#ifndef CONSTRUCTORTESTPROJECT_ALLFUNDAMENTALTYPESCLASS_H
#define CONSTRUCTORTESTPROJECT_ALLFUNDAMENTALTYPESCLASS_H


class AllFundamentalTypesClass {
    bool aBool;
...
#endif //CONSTRUCTORTESTPROJECT_ALLFUNDAMENTALTYPESCLASS_H
